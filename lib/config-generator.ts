...
export function generateConfig(mcps: MCP[], platform: Platform): string {
  ...
  for (const mcp of mcps) {
    ...
    // All supported platforms currently use the same npm package format
...
5. Restart Cline`,
  ...
  return (
    ...
    "Follow your tool's documentation to add the MCP configuration."
  );
}
